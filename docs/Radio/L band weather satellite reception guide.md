...
If you're reading this, you have probably been intrigued by the lower resolution VHF imagery you can get. Well, you're in for a ride! We'll be covering both LEO satellite reception including some familiar faces, as well as geostationary satellite reception which will give you full disk Earth imagery. You can expect resolutions of roughly 1 km/px in most of this band. This guide will focus on the reception of the **L satellite band (~1.7 GHz)** 
...
- Offers much more interesting things than VHF - full and uncompressed LEO channels, full disk Earth imagery
- This heading will describe LEO satellites, you can skip to Geostationary satellites [here](#geostationary-reception)
...
- Full resolution sample imagery:
    ...
    - [4/221](https://cpt-dingus.cc/static/sat-images/L-band/LEO/NOAA%20POES/2024-12-01_10-05_noaa_hrpt_1.698%20GHz/avhrr_3_4-221%20Merge.png)
    - [NO](https://cpt-dingus.cc/static/sat-images/L-band/LEO/NOAA%20POES/2024-12-01_10-05_noaa_hrpt_1.698%20GHz/avhrr_3_NO%20enhancement.png)
...
- Full resolution sample imagery:
    - [Natural color](https://cpt-dingus.cc/static/sat-images/L-band/LEO/Meteor-M/2024-11-09_13-16_meteor_hrpt_1.7%20GHz/msu_mr_Natural%20Color.png)
    ...
    - [Day microphysics](https://cpt-dingus.cc/static/sat-images/L-band/LEO/Meteor-M/2024-11-09_13-16_meteor_hrpt_1.7%20GHz/msu_mr_Day%20Microphysics.png)
...
- Full resolution sample imagery:
    - [NOAA Natural color](https://cpt-dingus.cc/static/sat-images/L-band/LEO/Metop/2024-10-13_09-01_metop_ahrpt_1.693%20GHz/avhrr_3_NOAA%20Natural%20Color.png)
    - [221](https://cpt-dingus.cc/static/sat-images/L-band/LEO/Metop/2024-10-13_09-01_metop_ahrpt_1.693%20GHz/avhrr_3_AVHRR%20221%20False%20Color.png)
    - [Day microphysics](https://cpt-dingus.cc/static/sat-images/L-band/LEO/Metop/2024-10-13_09-01_metop_ahrpt_1.693%20GHz/avhrr_3_Day%20Microphysics%20(Metop).png)
...
- Full resolution sample imagery: TODO
...
# L-band Geostationary reception guide {#geostationary-reception}
...
> Please note that I call this band 'easy' because C-band LNBs paired with appropriately sized dishes are commercially available and very easily sourcable in **English speaking countries**. Places where C-band TV wasn't developed will have a significantly harder time getting this band.


- If you're in for easy reception, the road ends here for the time being. ***BUT***
if you:
    ...
    you might be interested in the **X-band**! It requires incomparably more dedication and effort to receive, but offers pretty much infinite possibilities - it's what the industry uses right now! With this band, the .5km/px quality is prevalent, but you can expect imagery with a quality as high as 60m/px with Meteor-M KMSS! (60m of course isn't the peak resolution in this band, some are MUCH better.)
