...
![Dissapointing SatDump screenshot showing barely a hint of a signal](./Assets/Sat-reception-journey/HRPT-disappointment-ss.png)
...
![A newer SatDump screenshot, now showing a much stronger albeit still useless HRPT signal](./Assets/Sat-reception-journey/New-helix-who-this.png)
...
![SatDump image showing a relatively weak Meteor-M HRPT broadcast](./Assets/Sat-reception-journey/Initial-Sawbird-SatDump-ss.png)
...
![Very cut up HRPT composite](./Assets/Sat-reception-journey/Initial-Sawbird-image.png)
...
![SatDump screenshot showing a very strong NOAA HRPT broadcast](./Assets/Sat-reception-journey/First-great-HRPT-SatDump.png)
*16 dB! This is more than enough for a gorgeous image and decode, an incomparable improvement!*

![HRPT composite](./Assets/Sat-reception-journey/First-great-HRPT.png)
...
![Picture of my HRPT setup](./Assets/Sat-reception-journey/Current-HRPT-setup.jpg)
